    ...
    if(data === undefined){
        return(
            ...
            <div className="flex flex-col items-center gap-2">
                ...
                <p className="">This won't take long</p>
            </div>
            </div>
        )
    }
    ...
    if(data === false){
        return(
            ...
            <div className="flex flex-col items-center gap-2">
                ...
                <p className="">This might take a while</p>
            </div>
            </div>
        )
    }
    ...
    <div className="bg-white">
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
            ...
            <div className="mt-10 border-t border-zinc-200">
                ...
                <h4 className="font-semibold text-gray-900 ">You made a great choice</h4>
                <p className="mt-2 text-sm text-zinc-600">
                   We at casecobra believe that a phone case doesn't only need to look good, but also last you for the years to come. We offer a 5-year print guarantee: If your case isn't of the highest quality,  we'd replace it for free
                </p>
                </div>
            </div>
