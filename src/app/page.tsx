  ...
  return (
    ...
    <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start ">
        ...
        <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900  text-5xl md:text-6xl lg:text-7xl" >
           Your image on a <span className="bg-green-500 px-2 text-white">custom</span> phone case </h1>
           <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap ">
      capture your favorite memories with you own,<span>one-of-one </span> phone case.
      CaseCobra allows you to protect your memories not only on your phone case 
           </p>
          ...
          mordern iPhone models supported  
           ...
           <div className="mt-12 flex flex-col sm:flex-col items-center sm:items-start gap-5">
            ...
            <img className="inline-block object-cover h-10 w-10 rounded-full ring-2 ring-slate-100" src="/users/user-5.jpg" alt="use image"/>
            </div>
          ...
          <Star className="h-4 w-4 text-green-600 fill-green-600"/>
            ...
            <p> <span className="font-semibold">1.250</span> happy customers
            </p>
            </div>
           </div>
        </div>
...
<p>
   "The case feels durable and i even got a compliment on the design. Had the case for two and a half month now and {" "} 
   <span className="p-0.5 bg-slate-800 text-white ">the image is super clear</span>, on the case i had before, the image started fading into yellowish color after a couple weeks. Love it"
</p>
      </div>
...
<p>
  ...
  on all of my last phone cases. This one, besides a barely noticiable scratch on the corner, {' '}
