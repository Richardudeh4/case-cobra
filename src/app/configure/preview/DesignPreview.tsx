...
import { COLORS, FINISHES, MODELS } from '@/src/validators/option-validator';
  ...
  const {mutate: createPaymentSession, isPending} = useMutation({
    ...
    onError: () => {
      toast({
        ...
        description: "Sorry, there was an error from our side, please try again",
        variant: "destructive"
      })
    }
  })
        ...
        <div className='sm:col-span-12 md:col-span-9 text-base'>
          <div className='grid grid-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10'>
            <div >
              ...
              <ol className=' text-zinc-700 list-disc list-inside mt-3'>
        ...
        <ol className='mt-3 text-zinc-700 list-disc list-inside'>
          ...
          <div className='mt-8'>
...

                {
                  material === "polycarbonate" ? (
                    <div className='flex items-center justify-between py-1 mt-2'>
                      ...
                      <p className='font-medium text-gray-900'>{formatPrice(PRODUCTS_PRICES.material.polycarbonate / 100)}</p>
                    </div>
                  ): null}
            ...
            <div className='mt-8 flex justify-end pb-12'>
                <Button isLoading={isPending} disabled={isPending} onClick={() => handleCheckout()}   className='px-4 sm:px-6 lg:px-8'>
